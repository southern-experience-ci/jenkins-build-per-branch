...
class Main {
    public static final Map<String, Map<String, Object>> opts = [
            ...
            g: [longOpt: 'template-prefix', required: true, args: 1, argName:  'genericTemplateName', description: "Generic Template Prefix - gradle flag -DgenericTemplateName=<template prefix>"],
